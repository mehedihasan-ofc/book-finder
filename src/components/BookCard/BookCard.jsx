...
const BookCard = ({ book, onFav }) => {
    return (
        <div className="space-y-3">
            ...
            >
                <img className="max-w-[144px] h-[200px] object-cover" src={book.bookImage} alt="book name" />
            </div>
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                        {
                            book.rating === 1 ? <img src={Star} />
                                : book.rating === 2 ? <><img src={Star} /> <img src={Star} /></>
                                    : book.rating === 3 ? <><img src={Star} /> <img src={Star} /> <img src={Star} /></>
                                        : book.rating === 4 ? <><img src={Star} /> <img src={Star} /> <img src={Star} /> <img src={Star} /></>
                                            : book.rating === 5 ? <><img src={Star} /> <img src={Star} /> <img src={Star} /> <img src={Star} /> <img src={Star} /></> : ''
                        }
                ...
                <div className="flex items-center gap-3 text-xs lg:text-sm">
                    ...
                    <button onClick={() => onFav(book.id)}
                        className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md py-1.5 transition-all lg:py-1.5 ${book.isFav ? 'bg-[#DC2954]/[14%] text-[#DC2954] hover:bg-[#DC2954]/[24%]' : 'bg-[#1C4336]/[14%] text-[#1C4336] hover:bg-[#1C4336]/[24%]'}`}
